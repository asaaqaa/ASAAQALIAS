...
class AsAsClient(TelegramClient):
    def zed_cmd(
        self: TelegramClient,
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @A_S_A_S_W\
                                  \n\n--------بـدء تتبـع سجـل الامبراطور ASAAQ♡--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع الامبراطور ASAAQ♡--------"
                        ...
                        link = "[𐇮 ♕الامبراطور𝞝‌ الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/A_S_A_S_W)"
                        text = (
                            "**✘ تقـريـر اشعـار الامبراطور ASAAQ♡ ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار الامبراطور ASAAQ♡ ✘**\n\n "
                        link = "[𐇮 ♕الامبراطور𝞝‌ الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/A_S_A_S_W)"
...
AsAsClient.fast_download_file = download_file
AsAsClient.fast_upload_file = upload_file
AsAsClient.reload = restart_script
AsAsClient.get_msg_link = get_message_link
AsAsClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    AsAsClient.send_message = send_message
    AsAsClient.send_file = send_file
    AsAsClient.edit_message = edit_message
