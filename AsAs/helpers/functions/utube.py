...
async def yt_search(AsAs):
    try:
        AsAs = urllib.parse.quote(AsAs)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={AsAs}"
        )
...
"""
async def yt_data(AsAs):
    params = {"format": "json", "url": AsAs}
