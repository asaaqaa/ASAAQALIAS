...
async def on_plug_in_callback_query_handler(event):
    ...
    try:
        ...
        return
    if os.path.exists("./AsAs/secret.txt"):
        jsondata = json.load(open("./AsAs/secret.txt"))
        try:
            ...
            reply_pop_up_alert = "- عـذراً .. هذه الرسـالة لم تعد موجـوده في سيـرفرات ASAAQ𝄞ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋ"
    else:
        reply_pop_up_alert = "- عـذراً .. هذه الرسـالة لم تعد موجـوده في سيـرفرات 𝄞ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋASAAQ"
