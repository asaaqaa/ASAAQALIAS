...
__version__ = "3.1.1"
__license__ = "تعديل الأمبراطورحفيد الملوگ المصدر سورس زد ثون "
__author__ = "AsAs <https://github.com/asaaqaa/ASAAQALIAS>"
__copyright__ = f"AsAs Copyright (C) 2021 - 2022  {__author__}"
