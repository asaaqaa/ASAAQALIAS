# Zed-Thon
# Copyright (C) 2023 asaaqaa . All Rights Reserved
#
...
#تخمييييييييييط سزرس زد ثون برعاية زلزال الامبراطور 
...
#تخمييييييط الامبراطور لسورس زلزال هيبه 
@zedub.zed_cmd(pattern="رابط(?:\s|$)([\s\S]*)")
async def song2(event):
    song = event.pattern_match.group(1)
    chat = "@apkdl_bot" # code by t.me/A_S_A_S_W
