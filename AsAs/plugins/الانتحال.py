...
DEFAULTUSERBIO = Config.DEFAULT_BIO or "- ‏وحدي أضيء، وحدي أنطفئ انا قمري اليالي وبدر  كُل نجومي..🤍"
...
async def _(event):
    ...
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID,
            f"#الانتحـــال\n ⪼ تم انتحـال كل  حسـاب الشخـص ↫ [{first_name}](tg://user?id={user_id }) بنجاح ✅",
        )
