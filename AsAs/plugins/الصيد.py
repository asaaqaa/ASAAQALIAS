...
ZelzalChecler_cmd = (
    "𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 الإمبراطور 𝞝 - اوامـر الصيـد والتشيكـر](t.me/kapo00s) 𓆪\n\n"
    ...
    try:
        ch = await zedub(
            functions.channels.CreateChannelRequest(
                title="⎉ صيـد الإمبراطور  AsAs⎉",
                about="This channel to hunt username by - @kapo00s ",
            )
        )
        ...
        if isav == True:
            try:
                ...
                await event.client.send_message(
                    event.chat_id,
                    "ᯓ AsAs 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - صيـد الإمبراطور  💡\n**•────────────────────•**\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Channel ❳\n**•────────────────────•**\n- By ❲ @kapo00s ❳ ".format(
