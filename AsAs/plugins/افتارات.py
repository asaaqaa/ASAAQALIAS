#♕الامبراطور♕ ®
#الملـف حقـوق وكتابـة زلـزال الهيبـه ⤶ @zzzzl1l خاص بسـورس ⤶ ♕الامبراطور♕
...
async def _(event):
    ...
    try:
        ...
        await event.client.send_file(
            event.chat_id,
            file=random.choice(AsAsR),
            caption=f"**🎆┊حـالات واتـس قصيـرة 🧸♥️**\n\n[➧𝙎𝙤𝙪𝙧𝙘𝙚 ♕الامبراطور♕](https://t.me/kapo00s)",
        )
...
async def _(event):
    ...
    try:
        ...
        await event.client.send_file(
            event.chat_id,
            file=random.choice(zedph),
            caption=f"**🎆┊صـورة ومعلومـة ➧ 🛤💡◟**\n\n[➧??𝙤𝙪𝙧𝙘𝙚 ♕الامبراطور♕](https://t.me/kapo00s)",
        )
        await zzevent.delete()
    except Exception:
        await zzevent.edit("**╮•⎚ عـذراً .. لـم استطـع ايجـاد المطلـوب ☹️💔**")
