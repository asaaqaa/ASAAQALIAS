...
# <https://www.github.com/asaaqaa/ASAAQALIAS/blob/maim/LICENSE/>.
""" 
Abuse Notifications for ZThon™ t.me/ZedThon
Write file by Zelzal t.me/A_S_A_S_W

حقوق السورس لزلزال الهيبة 
    ...
    if len(zed) == 2:
        ...
        for _ in range(counter):
            ...
            if event.reply_to_msg_id:
                ...
                await event.client.send_message('@AbuseNotifications', spam_message) # code by t.me/A_S_A_S_W
        ...
        return
    if DelaySpam is not True: # code by t.me/A_S_A_S_W
        if BOTLOG:
