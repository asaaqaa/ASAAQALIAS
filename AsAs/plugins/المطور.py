...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝞝 الإمبراطور 𝞝 - اوامــر المطـور المســاعد](t.me/kapo00s) 𓆪\n\n"
    ...
    "\n𓆩 [𐇮 الإمبراطور الهہـيـٖ͡ـ͢ـبـه 𐇮](t.me/A_S_A_S_P) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت الإمبراطور  انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن الإمبراطور :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت الإمبراطور  انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
