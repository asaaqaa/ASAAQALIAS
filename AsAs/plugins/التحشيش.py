...
zel_dev = (6126535154, 6218149232)
########################  SOURCE AMBRATWR~ BY: ASAAQ (@A_S_A_S_W)  ########################
...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/kapo00s) 🗑♻️𓆪\n**𓍹━─━─━─━─B𝞝R─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    if user.id == 6218149232or user.id == 6218149232or user.id == 2095357462:
...
########################  SOURCE AMBRATWR~ BY: ZelZal (@A_S_A_S_W)  ########################
...
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 الإمبراطور𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/kapo00s) 𓆪\n\n"
