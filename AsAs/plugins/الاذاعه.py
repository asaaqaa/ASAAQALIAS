...
ZelzalPRO_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 ⒶⓁⒶⓂⒷⓇⒶⓉⓌⓇ 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامـر الاذا؏ـــة](t.me/kapo00s) 𓆪\n\n"
    ...
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 ♕الامبراطور♕](t.me/kapo00s) 𓆪"
)
...
async def gcast(event):
    ...
    if zedthon: #Write Code By T.me/A_S_A_S_W
    ...
    async for x in event.client.iter_dialogs():
        if x.is_group:
            chat = x.id
            try:
                if zelzal.text: #Write Code By T.me/A_S_A_S_W
                    try:
                    ...
                    try: #Write Code By T.me/A_S_A_S_W
