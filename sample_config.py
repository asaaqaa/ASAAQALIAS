...
# قم بإنشاء ملف config.py جديد في نفس الدليل وقم بالاستيراد ، ثم قم بتوسيع هذه الفئة.
...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/asaaqaa/ASAAQALIAS.git"
    )
    # External plugins repo
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", None)
    if EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "no") and not url(EXTERNAL_REPO):
        EXTERNAL_REPO = "https://github.com/asaaqaa/ZedPlugins.git"
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "AsAs")
    ...
    # For updater plugin
    UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "AsAs")
    ...
    EXTERNAL_REPOBRANCH = os.environ.get("EXTERNAL_REPOBRANCH", "AsAs")
